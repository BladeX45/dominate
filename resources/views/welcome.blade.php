                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            {{-- center content --}}
                            <div class="col-lg-4">
                                {{-- advantages compared to other businesses --}}
                                {{-- affordable --}}
                                <div class="card my-1 p-auto bg-primary" style="min-height: 350px">
                                    <div class="feature-item">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p>
                                                Achieve top security in your journey! In our driving course, we prioritize safety. Our experienced instructors will guide you through each step carefully and ensure you are ready to face the road with confidence.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card my-1 p-auto bg-primary" style="min-height: 350px">
                                    <div class="feature-item">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p>
                                                Learn from expert drivers! Our instructors are committed experts who will teach you safe and efficient driving techniques. They will share their driving experience so you can become a skilled driver.
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card my-1 p-auto bg-primary" style="min-height: 350px">
                                    <div class="feature-item">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <p>
                                                Enjoy comfortable driving! In our course, you will drive with high-quality facilities. Our training vehicles are always in prime condition. Learning to drive has never been this easy.
                                            </p>
                                        </div>
                                    </div>
                                </div>

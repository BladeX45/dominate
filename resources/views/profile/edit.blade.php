...
<style>
                            ...
                            <form method="POST" action="{{ route('profile.photo') }}" autocomplete="off" enctype="multipart/form-data">
                                ...
                                <label for="inputGambar">
                                    ...
                                    @if (Auth::user()->avatar === null)
                                        ...
                                        <input type="file" id="inputGambar" name="photo" accept="image/*" style="display: none;">
                                    @else
                                        <div class="avatar-wrapper">
                                            <img id="blah" class="avatar" src="{{ asset('storage/assets/img/avatar') . '/' . auth()->user()->avatar }}" alt="">
                                        </div>
                                        <input type="file" id="inputGambar" name="photo" accept="image/*" style="display: none;">
                                    @endif
                                </label>
    ...
    <script>
        const imgInp = document.getElementById('inputGambar');
